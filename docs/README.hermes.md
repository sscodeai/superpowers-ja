# Superpowers 日本語版 — Hermes Agent 安装指南

在 [Hermes Agent](https://github.com/NousResearch/hermes-agent) 中使用 superpowers-ja 的完整指南。
...
如果希望全局使用 superpowers-ja skills，可以在 `~/.hermes/config.yaml` 中配置：
